  ...
  <div class="ftrsec-container">
    ...
    <div class="ftrsec-col">
      ...
      <ul class="ftrsec-links-list">
        <li><a href="about.php" class="ftrsec-link">About Us</a></li>
        <li><a href="blog.php" class="ftrsec-link">Blog</a></li>
        <li><a href="contact.php" class="ftrsec-link">Contact</a></li>
        <li><a href="login.php" class="ftrsec-link">Login</a></li>
      </ul>
    </div>
    ...
    class="ftrsec-social-btn ftrsec-insta"
...
>
          ...
          <!-- WhatsApp -->
          <a
            href="https://wa.me/<?php echo htmlspecialchars($global_info['globle_whatsapp'] ?? '', ENT_QUOTES); ?>"
            class="ftrsec-social-btn ftrsec-whatsapp"
            aria-label="WhatsApp"
            target="_blank"
            rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            ...
            class="ftrsec-social-btn ftrsec-youtube"
            aria-label="YouTube"
            target="_blank"
            rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          <a
            ...
            class="ftrsec-social-btn ftrsec-linkedin"
            aria-label="LinkedIn"
            target="_blank"
            rel="noopener noreferrer">
            <svg viewBox="0 0 24 24" fill="currentColor">
...
<div class="float-chat" id="chat_box" title="Chat">
  <a href="tel:<?php echo htmlspecialchars($global_info['globle_call_phone'] ?? ''); ?>">
...
<script>
  let number = "<?php echo htmlspecialchars($global_info['globle_whatsapp'] ?? '', ENT_QUOTES); ?>";
